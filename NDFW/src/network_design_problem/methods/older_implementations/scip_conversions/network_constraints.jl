...
MOI.get(o::Optimizer, cf::MOI.ConstraintFunction, ci::MOI.ConstraintIndex{<:SAF, S}) where {S <: BOUNDS} = MOI.get(o.sopt, cf, ci)
...
MOI.get(o::Optimizer, cs::MOI.ConstraintSet, ci::MOI.ConstraintIndex{<:SAF, S}) where {S <: BOUNDS} = MOI.get(o.sopt, cs, ci)
